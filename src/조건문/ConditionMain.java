...
public class ConditionMain {
    static void main(String[] args) {
        ...
        if ( kor < 0 || kor > 100 || en < 0 || en > 100 || mat < 0 || mat > 100) {
            System.out.print("성적 입력 오류");
        ...
        if ( avg >= 90) {
            System.out.print(name+", " + sum +", " + avg+", " + "등급 : A");
        }else if (avg >= 80) {
            System.out.print(name+", " + sum +", " + avg+", " + "등급 : B");
        }else if (avg >=70) {
            System.out.print(name+", " + sum +", " + avg+", " + "등급 : C");
        }else if (avg >=60) {
            System.out.print(name+", " + sum +", " + avg+", " + "등급 : D");
        }else {
            System.out.print(name+", " + sum +", " + avg+", " + "등급 : F");
        }
