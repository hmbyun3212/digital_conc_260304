...
public class DataTypeMain { // 파스칼 표기법
    static void main(String[] args) {
        ...
        boolean siTrue; // 1byte, true/flase
        ...
        //final double TAX RATE // 세율에 대한 상수 정의, 값이 대입된 이후 변경, 관례상 변수명은 대문자로 표시
        double taxRate = 0.10;  // 세율에 대한 변수 만들기
